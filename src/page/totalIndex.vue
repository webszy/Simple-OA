<template>
  <div class="bigBox" >
    ...
    <div class="totalLeft" v-bind:style="{height:curheight}">
      <div class="name">
        <h1 class="gonggongH1" style="cursor: pointer" title="这是一个小傻春">小小肖</h1>
      </div>
      <ul class="funList">
...
export default {
  ...
  mounted(){
   ...
   let leftHeight=document.getElementsByClassName("totalLeft").style.height;
    curheight.height=window.innerWeight || document.documentElement.clientHeight || document.body.clientHeight;
